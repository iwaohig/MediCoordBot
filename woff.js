...
// WOFF ID を定義
const WOFF_ID = "kBbua1fwJM-aIB37R4zrDA";
...
function submitForm() {
    ...
    fetch('https://prod-20.japaneast.logic.azure.com:443/workflows/91b26a2c98a645bfad40288757166584/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=Oi-ZatS2lr9kZWACiq3roW_e-lqt-Xsjbvo9gBR5XgQ', {
        method: 'POST',
        headers: {
